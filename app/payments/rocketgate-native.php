...
$request->Set(GatewayRequest::MERCHANT_CUSTOMER_ID(), $_SESSION['auth']['user_id']);
...
//$pp_response['transaction_id'] = (!empty($response->Get(GatewayResponse::RETRIEVAL_NO())))?$response->Get(GatewayResponse::RETRIEVAL_NO()):0;
