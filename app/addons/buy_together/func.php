        ...
        foreach ($chains as $key => $chain) {
            ...
            if (!empty($params['full_info'])) {
                if ($params['full_info']) {
                    ...
                    $_product['selected_options'] = isset($params['selected_options'][$_product['product_id'] . '_' . $chain['chain_id']]['selected_options'])
                        ? $params['selected_options'][$_product['product_id'] . '_' . $chain['chain_id']]['selected_options']
                        : '';

                    $_product['changed_option'] = isset($params['selected_options'][$_product['product_id'] . '_' . $chain['chain_id']]['changed_option'])
                        ? $params['selected_options'][$_product['product_id'] . '_' . $chain['chain_id']]['changed_option']
                        : '';
