...
{
    fn_set_notification('I', __('ebay_commercial_using_title'), __('ebay_commercial_using_text'), '', 'ebay_commercial_info');

    fn_set_hook('ebay_commercial_info_post');
}
...
{
    return __('ebay_license_notice', array(
        '[ebay_license_url]' => fn_ebay_get_license_url(),
        '[trial_license]' => fn_get_ebay_trail_license_key(),
        '[days]' => __('ebay_addon_plural_days', array(EBAY_TRIAL_LICENSE_LIFE_TIME))
    ));
}

/**
 * Return ebay license page url
 * @return string
 */
function fn_ebay_get_license_url()
{
    return Registry::get('config.resources.product_url') . '/ebay-synchronization.html';
}
