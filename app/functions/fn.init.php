...
function fn_check_cache($params)
{
    ...
    $core_hashes = array(
        'c8ea68d3187b6589ebec10a5472838bb8ba8244b' => array(
    ...
    if (fn_allowed_for('ULTIMATE')) {
        $core_hashes['c8ea68d3187b6589ebec10a5472838bb8ba8244b']['notice'] = $core_hashes['cb122cf60f32dc38f25bc4bac5ad4f24673ae3ea']['notice'] = 'fgber_zbqr_jvyy_or_punatrq_gb_serr';
    } else {
        $core_hashes['c8ea68d3187b6589ebec10a5472838bb8ba8244b']['notice'] = $core_hashes['cb122cf60f32dc38f25bc4bac5ad4f24673ae3ea']['notice'] = 'fgber_zbqr_jvyy_or_punatrq_gb_gevny';
    }
