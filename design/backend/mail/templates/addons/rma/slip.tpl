    ...
    <td width="100%" align="center">
        ...
        <tr>
            <td style="background-color: #ffffff; border: 1px solid #e6e6e6; margin: 0px auto; padding: 0px 40px 40px 40px; width: 510px;" align="left">
                ...
                <tr>
                    <td align="left" style="padding-bottom: 3px;" valign="middle"><img src="{$logos.mail.image.image_path}" width="150" border="0" alt="{$logos.mail.image.alt}" style="max-width:150px;"/></td>
                    <td width="100%" >&nbsp;</td>
                ...
                {if $return_info.comment}
                    <table style="direction: {$language_direction};">
                        ...
                        <tr>
                            <td>
                                <div style="padding-left: 7px; padding-bottom: 15px; overflow-x: auto; clear: both; width: 505px; height: 100%; padding-bottom: 20px; overflow-y: hidden;">{$return_info.comment|nl2br}</div>
                            </td>
                        </tr>
                    </table>
                {/if}
