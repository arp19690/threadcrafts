            ...
            <div class="upgrade-center_item">
                ...
                <div class="upgrade-center_content">
                    ...
                    {if !empty($package.conflicts)}
                        <div class="upgrade-center_install">
                            <a class="upgrade-center_pkg cm-dialog-opener cm-ajax btn" href="{"upgrade_center.conflicts?package_id=`$package.id`"|fn_url}" data-ca-target-id="conflicts_content_{$package.id}" data-ca-dialog-title="{__("conflicts")}: {$package.name|escape}">{__("conflicts")}</a>
                        </div>
                    {/if}
                </div>
