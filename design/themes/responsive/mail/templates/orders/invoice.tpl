...
<tr>
    ...
    <tr>
        <td style="background-color: #ffffff; border: 1px solid #e6e6e6; margin: 0px auto 0px auto; padding: 0px 44px 0px 46px; text-align: left;">
            ...
            <tr>
                <td align="left" style="padding-bottom: 3px;" valign="middle"><img src="{$logos.mail.image.image_path}" width="75" border="0" alt="{$logos.mail.image.alt}" style="max-width:75px;"/></td>
                <td width="100%" >&nbsp;</td>
