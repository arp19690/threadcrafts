...
<p class="bottom-copyright">&copy; {$smarty.const.TIME|date_format:"%Y"} Threadcrafts Pvt. Ltd. Powered by <a class="bottom-copyright" href="http://radsoft.co.in" target="_blank">Radsoft Solutions</a></p>