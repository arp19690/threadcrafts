<?php /* Smarty version Smarty-3.1.21, created on 2016-06-01 15:50:45
         compiled from "/var/www/html/design/backend/templates/buttons/helpers.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2080316289574eda25f0d813-62132338%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7630ac9d22f3ce0d4b2a7fd0761dd6c20063667f' => 
    array (
      0 => '/var/www/html/design/backend/templates/buttons/helpers.tpl',
      1 => 1450182318,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2080316289574eda25f0d813-62132338',
  'function' => 
  array (
    'btn' => 
    array (
  ...
  'unifunc' => 'content_574eda2608fa41_83369673',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_574eda2608fa41_83369673')) {function content_574eda2608fa41_83369673($_smarty_tpl) {?><?php
fn_preload_lang_vars(array('delete_selected','delete','tools'));
?>

<?php if (!is_callable('smarty_function_script')) include '/var/www/html/app/functions/smarty_plugins/function.script.php';
...
if (!$_smarty_tpl->tpl_vars['hide_add']->value) {?><li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"text",'onclick'=>"Tygh."."$"."('#box_' + this.id).cloneNode(".((string)$_smarty_tpl->tpl_vars['tag_level']->value)."); ".((string)$_smarty_tpl->tpl_vars['on_add']->value),'id'=>$_smarty_tpl->tpl_vars['item_id']->value));?>
</li><?php }
if (!$_smarty_tpl->tpl_vars['hide_clone']->value) {?><li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"text",'onclick'=>"Tygh."."$"."('#box_' + this.id).cloneNode(".((string)$_smarty_tpl->tpl_vars['tag_level']->value).", true);",'id'=>$_smarty_tpl->tpl_vars['item_id']->value));?>
</li><?php }
}?><li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"text",'only_delete'=>$_smarty_tpl->tpl_vars['only_delete']->value,'class'=>"cm-delete-row"));?>
</li>
    <?php }?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['type']->value=="text_add") {?>
        <?php smarty_template_function_btn($_smarty_tpl,array('type'=>"text",'text'=>$_smarty_tpl->tpl_vars['text']->value,'class'=>"btn btn-primary ".((string)$_smarty_tpl->tpl_vars['class']->value),'icon'=>"icon-plus icon-white",'icon_first'=>true,'href'=>$_smarty_tpl->tpl_vars['href']->value));?>
...
<?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/app/lib/vendor/smarty/smarty/libs/plugins/modifier.replace.php';
