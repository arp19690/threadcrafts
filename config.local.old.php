 ...
 */
$config['db_host'] = 'threadcrafts.cqrkhkpyejgf.us-east-1.rds.amazonaws.com';
$config['db_name'] = 'threadcrafts';
$config['db_user'] = 'threadcrafts';
$config['db_password'] = 'Threads987!';
...
$config['http_host'] = 'www.threadcrafts.in';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'www.threadcrafts.in';
$config['https_path'] = '';
...
$config['admin_index']    = 'admin-control.php';
